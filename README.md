...
# Assignment 3.11 MVP Demo
> At least two devices showing the functionality below
>
> ![Two_Devices.jpeg](images/Two_Devices.jpeg)

> Transmitting key data from the devices to a cloud server
>
> ![Metrics_Upload](images/Cloud_Metrics.png)
>
> We uploaded the values of temperature, humidity, left and right pressure, grinding count to the cloud.

>Demonstrating over-the-air firmware updates with signed images
>
> ![OTA_1](images/Cloud_OTA_1.png)
> ![OTA_2](images/Cloud_OTA_2.jpeg)
>
> We uploaded the signed DFU zip file of 0.0.3 version to the cloud. The nrf device management app can detect new version firmware and download it. And the device can receive and run the updated new version firmware.
...
>
> ![Multi_Devices](images/Multi_Devices_Management.png)
>
> We have two devices named as SmartPatch001 and SmartPatch002 and both of them can be recorded by the cloud.
