...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SYSTEM_WORKQUEUE_STACK_SIZE, 12288);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NORDIC_NRF7002_COEX_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPSL_CX_NRF70_SUPPORT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PM_PARTITION_SIZE_MEMFAULT_STORAGE, 0x20000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MEMFAULT_COREDUMP_STACK_SIZE_TO_COLLECT, 2048);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MEMFAULT_LOGGING_RAM_SIZE, 512);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MEMFAULT_METRICS_LOGS_ENABLE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MEMFAULT_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MEMFAULT_LOG_LEVEL, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NRF7002DK, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MBOX_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IPC_SERVICE_BACKEND_RPMSG_WQ_STACK_SIZE, 4096);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IPC_SERVICE_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_PROCESS_THREAD_STARTUP_DELAY_MS, 500);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUMGR_GRP_OS_INFO, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUMGR_GRP_OS_INFO_MAX_RESPONSE_SIZE, 256);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUMGR_TRANSPORT_WORKQUEUE_STACK_SIZE, 4096);
