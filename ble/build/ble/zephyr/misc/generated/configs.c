...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SUM_PRINT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MAIN_STACK_SIZE, 11264);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SYSTEM_WORKQUEUE_STACK_SIZE, 11264);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MDS_LOG_LEVEL, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IPC_SERVICE_BACKEND_RPMSG_WQ_STACK_SIZE, 2048);
