...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_TX_COUNT, 8);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HEAP_MEM_POOL_SIZE, 24576);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NRF7002DK_NRF5340_CPUNET, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SYNC_RTC_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF53_SYNC_RTC_IPM_OUT, 8);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF53_SYNC_RTC_IPM_IN, 7);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IPM_MSG_CH_7_ENABLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IPM_MSG_CH_7_RX, 1);
